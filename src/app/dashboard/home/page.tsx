    ...
    return (
        <div className="p-8 space-y-8 bg-gray-50 min-h-screen">
            ...
            <div className="text-center">
                <button className="bg-gradient-to-r from-green-400 to-blue-500 text-white px-8 py-3 rounded-full text-lg hover:scale-105 transition-transform duration-300">
